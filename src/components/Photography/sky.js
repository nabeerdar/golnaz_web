...
import flying_img_1 from '../../assets/flying_img_1.jpg';
import flying_img_2 from '../../assets/flying_img_2.jpg';
import flying_img_3 from '../../assets/flying_img_3.jpg';
...
function Sky() {
  ...
  const images = [flying_img_1, flying_img_2, flying_img_3];
      ...
      <div className="main-posts">
        ...
        {images.map((image, index) => (
          <div className="post-box" key={index} onClick={() => setSelectedImageIndex(index)}>
            <img src={image} alt={`flying_img_${index}`} />
          </div>
        ))}
      </div>
